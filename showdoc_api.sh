...
# 
api_key="fb9f51248e584f785abe21c4ab9fc96e1351069160" 			#api_key
api_token="7ac2f99bc448d9bd3ae7db092aa2b26a1129961731" 	#api_token
url="http://192.168.118.117/server/index.php?s=/api/open/fromComments" #同步到的url。使用www.showdoc.com.cn的不需要修改，使用私有版的请修改
#
#
#
#
